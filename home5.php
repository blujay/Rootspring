            ...
            <div class="content" role="main">
			  ...
			  <div class="subpages">
				<?php
					  ...
					  if ($children) { ?>
					  <ul>
					  <li class="section-link"><a href="/services">Services</a></li>
				<?php echo $children; ?>
					  </ul>
				<?php } ?>
			</div><!--.subpages-->
            ...
            <div class="content" role="main">
			  ...
			  <div class="subpages">
				<?php
					  ...
					  if ($children) { ?>
					  <ul>
					  <li class="section-link><a href="/about">About us</a></li>
				<?php echo $children; ?>
					  </ul>
				<?php } ?>
			</div><!--.subpages-->
...
<script type="text/javascript">
	  ...
	  $('').draggable();
		...
		$('#services div.service').click(function() {
...
function make_dynamic(container_select, links_select)
{
	...
	$(links_select).click(function(){
	    console.info('Loading thingy'); 
		var toLoad = $(this).attr('href')+' .hentry';	  
		window.location.hash = $(this).attr('href');
		$(container_select).load(toLoad, function(){
		   console.info('Loaded thingy');
...
$(document).ready(function() {
	...
	make_dynamic('#services .hentry','#services .subpages li a');
	make_dynamic('#item-info','#portfolio .item a');
	make_dynamic('#item-info','#portfolio .subpages .li a');
});
