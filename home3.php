			  ...
			  <?php /*  Allow screen readers / text browsers to skip the navigation menu and get right to the good stuff */ ?>
				<div class="skip-link screen-reader-text"><a href="#content" title="<?php esc_attr_e( 'Skip to content', 'twentyten' ); ?>"><?php _e( 'Skip to content', 'twentyten' ); ?></a></div>
					<ul id="menu" class="menu-beans">
						<li class="home"><a href="#menu">home</a></li>
						<li class="services"><a title="Find out how we can help you" href="#services">services</a></li>
						<li class="portfolio"><a title="Take a look at some websites we've brough to life" href="#portfolio">portfolio</a></li>
...
<div id="content">
		<!--Start introduction section-->
			<div class="r1-c1 tile" id="introduction">
				...
				<span class="back-pod"><a href="#menu" title="back to main menu" class="link-beans-hover">back to menu</a></span>
			...
			<span class="back-pod"><a href="#menu" title="back to main menu" class="link-beans button">back to menu</a></span>
